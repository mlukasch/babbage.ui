    ...
    value: function aggregate(endpoint, cube, originParams) {
      ...
      return this.getPackageModel(endpoint, cube).then(function (model) {
        ...
        _lodash2.default.each(measures, function (measure) {
          ...
          var measureModel = _lodash2.default.find(that.model.measures, function (measureModel) {
            return measureModel.label = measure.value;
          });
          result.summary["currency"] = measureModel["currency"];
        });
